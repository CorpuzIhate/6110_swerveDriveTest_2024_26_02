...
public class RobotContainer {
  ...
  private final LockOnCMD lockOnCMD = new LockOnCMD(swerveSubsystem, limeLightSub);
  ...
  NamedCommands.registerCommand("AutoTarget", lockOnCMD);
    ...
    autoChooser.setDefaultOption("basketballAuto", AutoBuilder.followPath(path));
  ...
  private void configureBindings() {
   ...
   new Joystick(driverJoyStick, OIConstants.kDriveShooterButtonIdx).whileTrue(new ShooterCMD(shooterSub, true, false))
